...
import { getFileUrl as getFileUrlAction } from "@/app/actions/files";
import { useToast } from "@/components/ui/use-toast";
import { updateDefaultRequirements } from "@/app/actions/organizations";
import { addRequirement, updateRequirementFile } from "@/app/actions/employees";
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-2">
                View and submit your required documents
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-6 flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Requirements</h1>
              <p className="text-gray-600 mt-2">
                Manage default requirements and employee documents
              </p>
            </div>
            <div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle>Employee Requirements</CardTitle>
                <Button
                  variant="outline"
                  size="sm"

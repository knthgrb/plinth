...
export default function AnnouncementsPage() {
  ...
  useEffect(() => {
    if (currentOrganizationId && setAnnouncementsLastSeen) {
      setAnnouncementsLastSeen({ organizationId: currentOrganizationId }).catch(
        () => {},
      );
    }
  }, [currentOrganizationId, setAnnouncementsLastSeen]);

...
export function CreateEmployeeDialog({
  ...
  const onValidSubmit = async (data: EmployeeFormValues) => {
    ...
    try {
      ...
      const regularHolidayOtRateDecimal = orgRegularHolidayOtDecimal;
      const specialHolidayOtRateDecimal = orgSpecialHolidayOtDecimal;
              ...
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="ce-middleName" {...register("middleName")} />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="ce-lastName" required>
                      Last Name
                    </Label>
                    <Input
                      id="ce-lastName"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="ce-email" required>
                      Email
                    </Label>
                    <Input
                      id="ce-email"
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="ce-phone" type="tel" {...register("phone")} />
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Used for province-specific holiday pay (e.g. Cebu-only
                      holidays).
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="ce-position" required>
                      Position
                    </Label>
                    <Input
                      id="ce-position"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="ce-department" required>
                      Department
                    </Label>
                    <Controller
                      name="department"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="ce-hireDate" required>
                      Hire Date
                    </Label>
                    <Controller
                      name="hireDate"
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">
                      Optional. When set, leave proration can start from this
                      date if enabled in Leave settings.
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="ce-basicSalary" required>
                      Basic Salary
                    </Label>
                    <Input
                      id="ce-basicSalary"
                ...
                {/* Pay rates now always follow organization defaults on create. Overrides are managed in the edit employee modal. */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">

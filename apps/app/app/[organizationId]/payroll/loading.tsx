      ...
      <div className="animate-pulse p-4 sm:p-6 lg:p-8 space-y-4">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <div className="h-8 w-36 rounded bg-[rgb(240,240,240)]" />
            <div className="h-4 w-56 rounded bg-[rgb(245,245,245)]" />
          </div>
          <div className="h-9 w-32 rounded bg-[rgb(240,240,240)]" />
        </div>
        <div className="flex gap-2">
          <div className="h-8 w-24 rounded bg-[rgb(245,245,245)]" />
          <div className="h-8 w-24 rounded bg-[rgb(245,245,245)]" />
          <div className="h-8 w-28 rounded bg-[rgb(245,245,245)]" />
        </div>

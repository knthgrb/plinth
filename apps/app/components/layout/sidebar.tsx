    ...
    items: [
      {
        ...
        href: "/employees",
        icon: Users,
        roles: rolesForPath("/employees"),
      },
      {
        name: "Attendance",
        href: "/attendance",
        icon: Clock,
        roles: rolesForPath("/attendance"),
      },
      {
        name: "Evaluations",
        href: "/evaluations",
        icon: FileText,
        roles: rolesForPath("/evaluations"),
      },
      {
        name: "Leave",
        href: "/leave",
      ...
      },
      {
        ...
        href: "/requirements",
        icon: ClipboardList,
        roles: rolesForPath("/requirements"),
      },
      {
        name: "Recruitment",
        href: "/recruitment",
        icon: Briefcase,
        roles: rolesForPath("/recruitment"),
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        href: "/documents",
        icon: FileText,
        roles: rolesForPath("/documents"),
      },
      {
        name: "Assets Management",
        href: "/assets",
        icon: Package,
        roles: rolesForPath("/assets"),
      },
    ],
  },
];
  ...
  const renderNavItem = (item: NavigationItem, isSubItem = false) => {
    ...
    return (
      ...
      >
        ...
        {item.href === "/chat" && chatUnreadTotal > 0 && (
          <span className="ml-auto shrink-0 min-w-[1.25rem] h-5 flex items-center justify-center rounded-full bg-red-500 text-white text-xs font-semibold px-1.5">

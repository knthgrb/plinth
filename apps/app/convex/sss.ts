...
export type SSSContribution = {
  ...
  /** Employer share (monthly) - employer/company contribution */
...
/**
 * Get SSS contribution data based on the employee's deducted SSS amount.
 * Example: employee deduction 900 -> employer 1830, total 2730.
 */
export function getSSSContributionByEmployeeDeduction(
  ...
  const nearest = SSS_TABLE.reduce((closest, bracket) => {
